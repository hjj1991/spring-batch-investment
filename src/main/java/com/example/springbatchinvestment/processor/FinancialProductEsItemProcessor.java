                                ...
                                .map(
                                        option ->
                                                FinancialProductDocument.Option.builder()
                                                        ...
                                                        .initRate(option.getBaseInterestRate() != null ? option.getBaseInterestRate().doubleValue() : 0.0)
                                                        .maxRate(option.getMaximumInterestRate() != null ? option.getMaximumInterestRate().doubleValue() : 0.0)
                                                        .build())
                                .toList())
